...
import { PropsWithChildren, PropsWithClass } from "../shared/components.tsx";
...
function NavBar() {
  return (
    <div class="fixed left-0 right-0 top-0 p-6 bg-gray-700 shadow-md">
...
function Container(props: PropsWithClass & PropsWithChildren) {
  const classes = `
    max-w-2xl mx-auto
    flex justify-center
    ${props.class ?? ""}
